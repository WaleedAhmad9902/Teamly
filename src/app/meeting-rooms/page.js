...
const MeetingRoomPage = () => {
  ...
  useEffect(() => {
    const fetchWorkspaces = async () => {
      try {
        const response = await fetch('/data/meetingRooms.json'); // Adjust path if needed
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="relative z-10 text-left px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl text-gray-200">
            <Link href="/" className="underline hover:text-gray-300">Home</Link> / Meeting Room
          </h2>
          <h1 className="text-7xl font-bold mt-4">Meeting Room</h1>
      ...
      <div className="p-8">
        <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Our Meeting Rooms</h2>
